import { AuthJwtPayload } from "../utils/auth.utils.js";
...
type PassauthHandlerPrivate = {
    ...
    saveRefreshToken(userId: ID, refreshToken: string, exp: number): Promise<void>;
    hashRefreshToken(token: string, userId: ID): Promise<string>;
    compareRefeshToken(token: string, userId: ID, hashedToken: string): Promise<boolean>;
};
